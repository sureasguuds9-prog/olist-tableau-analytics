...
![Статус](https://img.shields.io/badge/статус-части%201–2%20готовы-2E8B57)
![Язык](https://img.shields.io/badge/интерфейс-русский-4C78A8)

Pet-проект по аналитике бразильского маркетплейса Olist. Две готовые части Tableau-проекта объединяют Executive Overview и углублённый анализ клиентов, повторных покупок, удержания и RFM-сегментов.
