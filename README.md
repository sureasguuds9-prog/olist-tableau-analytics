...
![Статус](https://img.shields.io/badge/статус-часть%201%20готова-2E8B57)
![Язык](https://img.shields.io/badge/интерфейс-русский-4C78A8)

Первая часть pet-проекта по аналитике бразильского маркетплейса Olist. Интерактивный Tableau-дашборд объединяет продажи, клиентов, ассортимент, географию, доставку и отзывы в одном управленческом экране.
...
- PNG экспортирован средствами Tableau в разрешении 2980×1962.
...
- **Часть 2 — Customer & Retention:** когорты, повторные покупки и RFM.
- **Часть 3 — Delivery & Service Quality:** задержки, регионы риска и детальный анализ отзывов.
